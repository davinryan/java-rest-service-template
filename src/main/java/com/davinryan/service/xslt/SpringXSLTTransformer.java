...
import com.davinryan.common.restservice.logging.LogUtil;
import com.davinryan.service.util.XmlObjectMapper;
...
public class SpringXSLTTransformer implements XSLTTransformer {
     ...
     */
    @Override
    public String generateXML(Object invoice) {
    ...
    private String convertPojoToXml(Object invoice) {
