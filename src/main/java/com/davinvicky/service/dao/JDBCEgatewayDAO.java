...
@Component
public class JDBCEgatewayDAO implements JDBCDAO {

    private static final Logger LOGGER = LoggerFactory.getLogger(JDBCEgatewayDAO.class.getName());
