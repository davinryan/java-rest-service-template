...
@Documented
public @interface SumOfFeesShouldNotExceedValue {
    String message() default "SumOfFeesShouldNotExceedValue validation failed on this object. Look at @SumOfFeesShouldNotExceedValue annotation at top of class for more details.";
     ...
     *
     * @see SumOfFeesShouldNotExceedValue
     */
    @Target({TYPE, ANNOTATION_TYPE})
    @Retention(RUNTIME)
    @Documented
    @interface List {
        SumOfFeesShouldNotExceedValue[] value();
    }
}
