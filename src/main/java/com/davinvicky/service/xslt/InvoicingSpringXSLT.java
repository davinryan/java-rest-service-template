...
import nz.co.acc.myacc.common.logging.LogUtil;
 ...
 */
@Component
public class InvoicingSpringXSLT implements InvoicingXSLT {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(InvoicingSpringXSLT.class.getName());
